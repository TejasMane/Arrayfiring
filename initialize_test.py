...
initial_position_x = 0.4 + left_boundary   + 0.1 * length_box_x * af.randu(no_of_particles)
initial_position_y = 0.4 + bottom_boundary + 0.1 * length_box_y * af.randu(no_of_particles)
initial_position_z = 0.4 + back_boundary   + 0.1 * length_box_z * af.randu(no_of_particles)
